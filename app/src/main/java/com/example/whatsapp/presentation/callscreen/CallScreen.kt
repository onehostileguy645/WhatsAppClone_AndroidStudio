...
fun CallScreen(){
    ...
    val sampleCall = listOf(
        Call(R.drawable.ssa, "ssa", "Yesterday, 8:30 AM", true),
        Call(R.drawable.ssa, "ssa", "Yesterday, 8:30 AM", true),
        Call(R.drawable.ssa, "ssa", "Yesterday, 8:30 AM", true),
        Call(R.drawable.ssa, "ssa", "Yesterday, 8:30 AM", true),
        Call(R.drawable.ssa, "ssa", "Yesterday, 8:30 AM", true),
    ...
    Scaffold (
        ...
        Column (modifier = Modifier.padding(it)){
            ...
            Button(
                ...
                Text(text = "Start a new call", color = Color.White, fontSize = 16.sp, fontWeight = FontWeight.Bold)
            }

            Spacer(modifier = Modifier.height(8.dp))

            Text(text = "Recent Calls", fontSize = 20.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp))
